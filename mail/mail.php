...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('secure177.inmotionhosting.com', 25, 'tls' )
	  ->setUsername('hello@trailersquad.com')     
	  ->setPassword('5TgbvfR4')
	  ;
	...
	$message = Swift_Message::newInstance('A message from TrailerSquad')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('hello@trailersquad.com' => 'Chris'))->setBody($messageText);
//                           ^                    ^
